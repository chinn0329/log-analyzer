...
def explain_anomalies(
    ...
    Groq's LPU-based free tier is fast enough that a much smaller delay
    is needed between calls than typical GPU-based free tiers.
    ...
    print(f"[LLM] Done. {len(to_explain)} explanations generated in {elapsed:.1f}s.")
    return logs